...
namespace SpaceInvoices.Infrastructure
{
    internal class Client
    {
        ...
        {
            RequestMessage.Headers.UserAgent.ParseAdd($"SpaceInvoices/v1 .NetBindings/{SpaceConfiguration.SpaceInvoicesNetVersion}");
        }

        public void ApplyClientData()
        {
            RequestMessage.Headers.Add("X-SpaceInvoices-Client-User-Agent", GetClientUserAgentString());
        }
        ...
        private string GetClientUserAgentString()
        {
            ...
            {
                { "bindings_version", SpaceConfiguration.SpaceInvoicesNetVersion },
                { "lang", ".net" },
                { "publisher", "space invoices" },
            };
